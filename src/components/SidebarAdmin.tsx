...
const sidebarMenu = [
  ...
  },
  {
    ...
    children: [
      {
        label: "Staff & Pimpinan",
        href: "/admin/sdm-organisasi/staff",
        icon: User2,
      },
      {
        label: "Statistik & Analisis",
        href: "/admin/sdm-organisasi/statistik",
        icon: BarChart3,
      },
    ],
  },
  {
    ...
    children: [
      ...
      {
        label: "Bidang Tata Lingkungan",
        href: "/admin/bidang/tata-lingkungan",
        icon: TreePine,
      },
      {
        label: "Bidang Pengendalian Pencemaran",
        href: "/admin/bidang/pengendalian-pencemaran",
        icon: AlertTriangle,
      },
      {
        label: "Bidang Pengelolaan Sampah",
        href: "/admin/bidang/pengelolaan-sampah",
        icon: Recycle,
      },
    ],
  },
  ...
  },
  {
    ...
    icon: Newspaper,
    children: [
      { label: "Banner", href: "/admin/carousel", icon: FileImage },
      {
        label: "Layanan Section",
        href: "/admin/layanan-section",
        icon: Grid3X3,
      },
      {
        label: "Statistik Section",
        href: "/admin/statistics-section",
        icon: BarChart3,
      },
      {
        label: "Social Media Gallery",
        href: "/admin/social-media-gallery",
        icon: FileVideo,
      },
  ...
  },
  {
    ...
    children: [
      ...
      {
        label: "Panduan Perizinan",
        href: "/admin/panduan/perizinan",
      ...
      <div className="flex-1 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-300 dark:scrollbar-thumb-gray-600 scrollbar-track-transparent">
        <nav className="p-4 space-y-2">
          ...
          >
            ...
            <span className="flex-1">Pengaturan Website</span>
          </Link>
        </nav>
      </div>
