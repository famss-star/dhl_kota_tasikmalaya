...
const UklUplSubmissionForm = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('/api/public/perizinan/ukl-upl/submit', {
        method: 'POST',
        headers: {
      ...
      <div className="max-w-4xl mx-auto bg-white dark:bg-gray-800 rounded-lg shadow p-8">
        <div className="text-center">
          ...
          <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
            Pengajuan UKL-UPL Berhasil Dikirim!
          </h3>
    ...
    <div className="max-w-4xl mx-auto bg-white dark:bg-gray-800 rounded-lg shadow p-8">
      <div className="mb-8">
        <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4 flex items-center gap-3">
          <FileText className="w-8 h-8 text-green-600" />
          Formulir Pengajuan UKL-UPL
        </h2>
        <p className="text-gray-600 dark:text-gray-300">
          Silakan lengkapi formulir di bawah ini untuk mengajukan Upaya Pengelolaan Lingkungan Hidup dan Upaya Pemantauan Lingkungan Hidup (UKL-UPL)
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="space-y-6">
            <div>
              ...
              <input
                ...
                required
                className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent dark:bg-gray-700 dark:text-white"
                placeholder="Contoh: Pabrik Pengolahan Makanan"
              />
            </div>
          ...
          <div className="space-y-6">
            <div>
              ...
              <textarea
                ...
                rows={4}
                className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent dark:bg-gray-700 dark:text-white"
                placeholder="Deskripsikan upaya pengelolaan lingkungan yang akan dilakukan, seperti pengolahan limbah cair, pengendalian emisi, pengelolaan limbah padat, dll."
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                rows={4}
                className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent dark:bg-gray-700 dark:text-white"
                placeholder="Deskripsikan upaya pemantauan yang akan dilakukan, seperti monitoring kualitas air, udara, kebisingan, frekuensi pemantauan, dll."
              />
            </div>
          </div>
        </div>
        ...
        {/* Pernyataan */}
        <div className="border border-blue-200 bg-blue-50 dark:bg-blue-900/20 rounded-lg p-6">
          <h3 className="text-lg font-semibold text-blue-800 dark:text-blue-200 mb-3">
            Komitmen Pengelolaan Lingkungan
          </h3>
          <p className="text-sm text-blue-700 dark:text-blue-300 mb-4">
            Dengan mengajukan UKL-UPL ini, saya berkomitmen untuk:
          </p>
          <ul className="text-sm text-blue-700 dark:text-blue-300 space-y-1 list-disc list-inside">
            <li>Melaksanakan upaya pengelolaan lingkungan hidup sesuai dengan yang dinyatakan</li>
            <li>Melaksanakan upaya pemantauan lingkungan hidup secara berkala</li>
            <li>Membuat dan menyampaikan laporan pelaksanaan UKL-UPL sesuai jadwal</li>
            <li>Mematuhi peraturan perundang-undangan di bidang lingkungan hidup</li>
            <li>Bertanggung jawab atas dampak lingkungan yang ditimbulkan oleh kegiatan</li>
          </ul>
        </div>
...
export default UklUplSubmissionForm;
