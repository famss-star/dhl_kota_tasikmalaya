...
const layananPublik = [
  {
    nama: "Perizinan Lingkungan (AMDAL, UKL-UPL, SPPL)",
    deskripsi: "Pengajuan dan informasi terkait dokumen perizinan lingkungan hidup.",
    link: "/pelayanan/amdal"
  },
  {
    nama: "Pelayanan Pengelolaan Limbah Cair (IPLC)",
    deskripsi: "Layanan pengelolaan limbah cair domestik dan industri.",
    link: "/pelayanan/iplc"
  },
  {
    nama: "Pelayanan Pengelolaan Sampah",
    deskripsi: "Informasi dan permohonan layanan pengangkutan sampah."
  },
  {
    nama: "Pengaduan Lingkungan",
    deskripsi: "Layanan pelaporan masalah lingkungan hidup di Kota Tasikmalaya.",
    link: "/pengaduan"
  },
  {
    nama: "Permohonan Informasi Publik",
    deskripsi: "Akses dokumen dan data publik DLH Kota Tasikmalaya.",
    link: "/dokumen"
  }
];
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-12 border border-gray-200 dark:border-gray-700">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 grid-rows-4 gap-6">
              ...
              <div className="md:row-span-1 bg-gradient-to-br from-green-100 to-green-300 dark:from-green-900 dark:to-green-700 rounded-2xl p-8 flex flex-col justify-between shadow-lg">
                <h3 className="text-xl font-bold text-green-900 dark:text-green-200 mb-2">{layananPublik[0].nama}</h3>
                <p className="text-gray-800 dark:text-gray-100 mb-4">{layananPublik[0].deskripsi}</p>
                {layananPublik[0].link && (
                  <Link href={layananPublik[0].link} className="inline-block bg-green-700 hover:bg-green-800 text-white font-semibold py-2 px-4 rounded-lg transition duration-300">Lihat Detail</Link>
                )}
              </div>
              <div className="md:row-span-1 bg-gradient-to-br from-blue-100 to-blue-300 dark:from-blue-900 dark:to-blue-700 rounded-2xl p-8 flex flex-col justify-between shadow-lg">
                <h3 className="text-xl font-bold text-blue-900 dark:text-blue-200 mb-2">{layananPublik[1].nama}</h3>
                <p className="text-gray-800 dark:text-gray-100 mb-4">{layananPublik[1].deskripsi}</p>
                {layananPublik[1].link && (
                  <Link href={layananPublik[1].link} className="inline-block bg-blue-700 hover:bg-blue-800 text-white font-semibold py-2 px-4 rounded-lg transition duration-300">Lihat Detail</Link>
                )}
              </div>
              <div className="md:col-span-1 md:row-span-3 bg-gradient-to-br from-yellow-100 to-yellow-300 dark:from-yellow-900 dark:to-yellow-700 rounded-2xl p-8 flex flex-col justify-between shadow-lg">
                <h3 className="text-xl font-bold text-yellow-900 dark:text-yellow-200 mb-2">{layananPublik[2].nama}</h3>
                <p className="text-gray-800 dark:text-gray-100 mb-4">{layananPublik[2].deskripsi}</p>
              </div>
              ...
              <div className="md:col-span-2 md:row-span-2 bg-gradient-to-br from-pink-100 to-pink-300 dark:from-pink-900 dark:to-pink-700 rounded-2xl p-8 flex flex-col justify-between shadow-lg">
                <h3 className="text-xl font-bold text-pink-900 dark:text-pink-200 mb-2">{layananPublik[3].nama}</h3>
                <p className="text-gray-800 dark:text-gray-100 mb-4">{layananPublik[3].deskripsi}</p>
                {layananPublik[3].link && (
                  <Link href={layananPublik[3].link} className="inline-block bg-pink-700 hover:bg-pink-800 text-white font-semibold py-2 px-4 rounded-lg transition duration-300">Lihat Detail</Link>
                )}
              </div>
              ...
              <div className="md:col-span-3 md:row-span-1 bg-gradient-to-br from-purple-100 to-purple-300 dark:from-purple-900 dark:to-purple-700 rounded-2xl p-8 flex flex-col justify-between shadow-lg">
                <h3 className="text-xl font-bold text-purple-900 dark:text-purple-200 mb-2">{layananPublik[4].nama}</h3>
                <p className="text-gray-800 dark:text-gray-100 mb-4">{layananPublik[4].deskripsi}</p>
                {layananPublik[4].link && (
                  <Link href={layananPublik[4].link} className="inline-block bg-purple-700 hover:bg-purple-800 text-white font-semibold py-2 px-4 rounded-lg transition duration-300">Lihat Detail</Link>
                )}
              </div>
            </div>
          </div>
