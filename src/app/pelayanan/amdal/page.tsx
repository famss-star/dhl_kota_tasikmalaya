          ...
          <div className="bg-white dark:bg-gray-800 shadow-xl rounded-lg p-8">
            <div className="prose dark:prose-invert max-w-none">
              <p className="text-gray-700 dark:text-gray-300 mb-6">
                AMDAL adalah kajian mengenai dampak penting suatu rencana usaha dan/atau 
                kegiatan terhadap lingkungan hidup yang diperlukan bagi proses pengambilan 
                keputusan penyelenggaraan usaha.
              </p>
              <h3 className="text-2xl font-semibold mb-4 text-gray-800 dark:text-gray-100">
                Tujuan AMDAL
              </h3>
              <ul className="list-disc pl-6 space-y-3 text-gray-700 dark:text-gray-300">
                <li>Menjamin pembangunan yang berkelanjutan dan berwawasan lingkungan</li>
                <li>Mengidentifikasi dampak penting dari suatu kegiatan</li>
                <li>Menentukan kelayakan lingkungan suatu rencana usaha</li>
                <li>Merumuskan tindakan pengelolaan dan pemantauan lingkungan</li>
              </ul>
            </div>
          </div>
        </section>
