...
export default function AdminPerizinanUmum() {
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-4 flex items-center justify-center gap-3">
              ...
              Manajemen Perizinan Umum
            </h1>
            <p className="text-xl md:text-2xl opacity-90">Kelola data perizinan umum untuk website DLH Kota Tasikmalaya</p>
          </div>
        </div>
      </div>
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-8xl mx-auto bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 md:p-12 border border-gray-200 dark:border-gray-700">
          ...
          <div className="text-gray-600 dark:text-gray-300">(Dummy data perizinan umum di sini)</div>
        </div>
      </div>
    </div>
  );
