...
import { ArrowLeft, Edit, Trash2, Calendar, User, Eye, Globe, ChevronLeft } from "lucide-react";
...
export default function ViewBerita() {
  ...
  if (!news) {
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center">
        <div className="text-center">
          <h2 className="text-2xl font-bold text-gray-800 dark:text-white mb-4">Berita tidak ditemukan</h2>
          <button
      ...
      <div className="bg-gradient-to-r from-yellow-600 to-green-600 text-white py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl opacity-90">Preview berita untuk website DLH</p>
          </div>
        </div>
      </div>
