...
export default function CreateBerita() {
  ...
  useEffect(() => {
    ...
    if (authData) {
      ...
      console.log('🔍 Current user set:', parsed.user);
    } else {
      console.log('❌ No auth data found in localStorage or sessionStorage');
    }
  }, []);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        alert(data.error || 'Gagal membuat berita');
      }
    } catch (error) {
      ...
      <div className="bg-gradient-to-r from-purple-600 to-pink-600 text-white py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl opacity-90">Tambahkan berita baru untuk website DLH</p>
          </div>
        </div>
      </div>
