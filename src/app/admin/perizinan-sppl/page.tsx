...
export default function AdminPerizinanSppl() {
  return (
      ...
      <div className="bg-gradient-to-r from-green-600 to-blue-600 text-white py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl opacity-90">Kelola data perizinan SPPL untuk website DLH Kota Tasikmalaya</p>
          </div>
        </div>
      </div>
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-8xl mx-auto bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 md:p-12 border border-gray-200 dark:border-gray-700">
          <h2 className="text-2xl font-bold text-gray-800 dark:text-white mb-8 flex items-center gap-2">
            ...
            Daftar Perizinan SPPL
          </h2>
          <div className="text-gray-600 dark:text-gray-300">(Dummy data perizinan SPPL di sini)</div>
        </div>
      </div>
    </div>
  );
