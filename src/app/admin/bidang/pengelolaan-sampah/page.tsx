...
export default function AdminBidangPengelolaanSampahPage() {
  ...
  const {
    ...
    error,
    updateBidangData,
  } = useBidangData("pengelolaan-sampah");
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      alert("Data Bidang Pengelolaan Sampah berhasil disimpan!");
    } catch (error) {
      alert(
        error instanceof Error
          ? error.message
          : "Gagal menyimpan data Bidang Pengelolaan Sampah"
      );
    } finally {
      setIsLoading(false);
    }
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-yellow-700 dark:text-yellow-400">
                Data bidang pengelolaan sampah tidak ditemukan.
              </p>
            </div>
          </div>
        </div>
              ...
              <div>
                <div className="flex items-center justify-between mb-4">
                  ...
                  <button
                    type="button"
                    onClick={addTugas}
                    className="inline-flex items-center px-3 py-1 border border-transparent text-sm leading-4 font-medium rounded-md text-white bg-emerald-600 hover:bg-emerald-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500"
                  >
                ...
                <div className="space-y-3">
                  {bidangData.tugasPokok.map((tugas, index) => (
                    <div key={index} className="flex items-start gap-3">
                      ...
                      <textarea
                        rows={2}
                        className="flex-1 px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-emerald-500 focus:border-emerald-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                        value={tugas}
          ...
          {activeTab === "preview" && (
            <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
              ...
              <div className="container mx-auto px-4 py-12">
                ...
                <section className="max-w-6xl mx-auto mb-8">
                  <div className="bg-white dark:bg-gray-800 shadow-xl rounded-lg p-8">
                    <div className="prose dark:prose-invert max-w-none">
                      <h2 className="text-3xl text-center font-bold text-gray-800 dark:text-white mb-6 border-b-4 border-emerald-500 pb-2">
                ...
                {/* Rincian Tugas Bidang Pengelolaan Sampah */}
                <section className="max-w-6xl mx-auto mb-12">
                  <div className="bg-white dark:bg-gray-800 shadow-xl rounded-lg p-8">
                    <h3 className="text-3xl text-center flex items-center justify-center gap-3 font-bold text-gray-800 dark:text-white mb-6 border-b-4 border-emerald-500 pb-2">
