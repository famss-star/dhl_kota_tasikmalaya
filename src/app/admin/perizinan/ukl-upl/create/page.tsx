...
export default function CreatePerizinanUklUpl() {
  ...
  const handleDocumentUpload = async (
    ...
    for (let i = 0; i < files.length; i++) {
      ...
      try {
        ...
        formDataUpload.append("folder", "perizinan-ukl-upl");
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch("/api/perizinan/ukl-upl", {
        method: "POST",
        headers: {
      ...
      if (data.success) {
        alert("UKL-UPL berhasil dibuat!");
        router.push("/admin/perizinan/ukl-upl");
      } else {
        alert(data.error || "Gagal membuat UKL-UPL");
      }
    } catch (error) {
      console.error("Create UKL-UPL error:", error);
      alert("Terjadi kesalahan saat membuat UKL-UPL");
    } finally {
      setLoading(false);
    }
  };
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl opacity-90">
              Kelola Upaya Pengelolaan Lingkungan Hidup dan Upaya Pemantauan
              Lingkungan Hidup
            </p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="bg-gray-50 dark:bg-gray-700/30 rounded-lg p-6">
            ...
            <div className="flex items-center mt-6">
              ...
              >
                Persyaratan UKL-UPL telah terpenuhi
              </label>
            </div>
          </div>
          ...
          <div className="flex gap-4 pt-6">
            ...
            >
              ...
              {loading ? "Menyimpan..." : "Buat UKL-UPL"}
            </button>
          </div>
        </form>
      </div>
