...
export default function CreatePerizinanUmum() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.success) {
        alert("Perizinan umum berhasil dibuat!");
        router.push("/admin/perizinan/umum");
      } else {
        alert(data.error || "Gagal membuat perizinan umum");
      }
    } catch (error) {
      console.error("Create perizinan error:", error);
      alert("Terjadi kesalahan saat membuat perizinan umum");
    } finally {
      setLoading(false);
    }
  };
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl opacity-90">
              Tambahkan perizinan umum baru untuk sistem DLH
            </p>
          </div>
        </div>
      </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex gap-4 pt-6">
            ...
            >
              ...
              {loading ? "Menyimpan..." : "Buat Perizinan"}
            </button>
          </div>
        </form>
      </div>
