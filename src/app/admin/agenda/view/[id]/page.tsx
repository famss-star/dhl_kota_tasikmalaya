...
export default function AdminAgendaView() {
    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-2 text-gray-600 dark:text-gray-400">Memuat agenda...</p>
        </div>
      </div>
    );
  }
  ...
  if (!agenda) {
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center">
        <div className="text-center">
          <h2 className="text-2xl font-bold text-gray-800 dark:text-white mb-4">Agenda tidak ditemukan</h2>
          <button
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="bg-gradient-to-r from-gray-700 to-green-600 text-white py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl opacity-90">Preview agenda untuk website DLH</p>
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-8xl mx-auto bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700">
          ...
          <div className="p-8 border-b border-gray-200 dark:border-gray-700">
            ...
            <div className="flex items-center gap-4 mb-4">
              <span className={`px-3 py-1 rounded-full text-sm font-semibold ${
                ...
                {agenda.status === 'UPCOMING' ? 'Akan Datang' :
                 agenda.status === 'ONGOING' ? 'Berlangsung' :
                 agenda.status === 'COMPLETED' ? 'Selesai' : 'Dibatalkan'}
              </span>
            </div>
            ...
            <div className="flex flex-wrap items-center gap-6 text-sm text-gray-600 dark:text-gray-400">
              ...
              <div className="flex items-center gap-2">
                ...
                <span>{formatDate(agenda.createdAt)}</span>
              </div>
              <div className="flex items-center gap-2">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-gray-900 dark:text-white">{agenda.location}</p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-gray-900 dark:text-white">{agenda.participants} orang</p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  <Clock className="w-5 h-5 text-blue-600" />
                  <div>
                    <p className="text-sm text-gray-600 dark:text-gray-400">Waktu Mulai</p>
                    <p className="font-semibold text-gray-900 dark:text-white">{formatDateTime(agenda.startDate, agenda.startTime)}</p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-gray-900 dark:text-white">{formatDateTime(agenda.endDate, agenda.endTime)}</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          {/* Content */}
          <div className="p-8 border-b border-gray-200 dark:border-gray-700">
            <h3 className="text-lg font-semibold text-gray-800 dark:text-white mb-4">Deskripsi</h3>
