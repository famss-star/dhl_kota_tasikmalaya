...
import { Plus, Edit, Trash2, Upload, Eye, EyeOff, Save, X, Image as ImageIcon } from "lucide-react";
...
export default function CarouselAdmin() {
    ...
    const mockData: CarouselItem[] = [
      {
        ...
        description: "Melayani masyarakat dengan profesional dalam bidang lingkungan hidup",
      ...
      },
      {
        ...
        description: "Ajukan perizinan lingkungan secara online dengan mudah dan cepat",
      ...
      },
      {
        ...
        description: "Mari bersama-sama menjaga lingkungan melalui program bank sampah",
  ...
  const handleDelete = async (id: string) => {
    if (!confirm("Apakah Anda yakin ingin menghapus item carousel ini?")) return;
  ...
  const toggleActive = async (id: string, isActive: boolean) => {
    try {
      ...
      setCarouselItems(prev => prev.map(item => 
        item.id === id 
          ? { ...item, isActive: !isActive, updatedAt: new Date().toISOString() }
          : item
      ));
    } catch (error) {
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-green-50 to-emerald-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 p-4 md:p-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center py-12">
            ...
            <p className="mt-4 text-gray-600 dark:text-gray-400">Memuat data carousel...</p>
          </div>
        </div>
      </div>
    );
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-green-50 to-emerald-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 p-4 md:p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-xl md:text-2xl opacity-90">Atur banner dan slide utama website DLH Kota Tasikmalaya</p>
        </div>
