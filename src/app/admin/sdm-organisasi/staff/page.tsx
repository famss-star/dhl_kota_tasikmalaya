...
const StaffPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const url = editingStaff 
        ? `/api/admin/staff-members?id=${editingStaff.id}`
  ...
  const handleDelete = async (id: string) => {
    if (confirm('Are you sure you want to delete this staff member?')) {
      try {
        const response = await fetch(`/api/admin/staff-members?id=${id}`, {
          method: 'DELETE',
        });
      ...
      <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900">Staff & Pimpinan</h1>
              <p className="text-gray-600">Manage staff members and leadership</p>
            </div>
          </div>
          <div className="flex items-center space-x-4">
          ...
          {activeTab === 'PREVIEW' ? (
            <div className="space-y-8">
              ...
              <div className="text-center mb-8">
                ...
                <p className="text-gray-600">Dinas Lingkungan Hidup Kota Tasikmalaya</p>
              </div>
              ...
              <div className="max-w-4xl mx-auto">
                ...
                {getKepalaDinas() && (
                  <div className="flex justify-center mb-8">
                    <div className="bg-blue-50 border-2 border-blue-200 rounded-lg p-6 text-center max-w-xs">
                      ...
                      <h3 className="font-bold text-gray-900 mb-1">{getKepalaDinas()!.name}</h3>
                      <p className="text-blue-600 font-medium text-sm mb-2">{getKepalaDinas()!.position}</p>
                ...
                <div className="flex justify-center gap-8 mb-8">
                  {getWakil() && (
                    <div className="bg-green-50 border-2 border-green-200 rounded-lg p-6 text-center max-w-xs">
                      ...
                      <h3 className="font-bold text-gray-900 mb-1">{getWakil()!.name}</h3>
                      <p className="text-green-600 font-medium text-sm mb-2">{getWakil()!.position}</p>
                      <div className="flex items-center justify-center text-xs text-gray-500">
                        <Badge className="h-3 w-3 mr-1" />
                  ...
                  {getSekretaris() && (
                    <div className="bg-purple-50 border-2 border-purple-200 rounded-lg p-6 text-center max-w-xs">
                      ...
                      <h3 className="font-bold text-gray-900 mb-1">{getSekretaris()!.name}</h3>
                      <p className="text-purple-600 font-medium text-sm mb-2">{getSekretaris()!.position}</p>
                      <div className="flex items-center justify-center text-xs text-gray-500">
                        <Badge className="h-3 w-3 mr-1" />
                ...
                {getKabids().length > 0 && (
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900 text-center mb-6">Kepala Bidang</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                      {getKabids().map((kabid) => (
                        <div key={kabid.id} className="bg-orange-50 border-2 border-orange-200 rounded-lg p-4 text-center">
                          <div className="w-16 h-16 mx-auto mb-3 rounded-full overflow-hidden border-4 border-orange-200">
                            <Image
                          ...
                          <h4 className="font-bold text-gray-900 mb-1 text-sm">{kabid.name}</h4>
                          <p className="text-orange-600 font-medium text-xs mb-2">{kabid.position}</p>
                          <div className="flex items-center justify-center text-xs text-gray-500">
                            <Badge className="h-3 w-3 mr-1" />
              ...
              {filteredStaff.length === 0 ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {filteredStaff.map((staff) => (
                    <div key={staff.id} className="bg-gray-50 rounded-lg p-6 border border-gray-200">
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4">
              ...
              <div>
                ...
                >
                  ...
                  <option value="WAKIL">Wakil Kepala Dinas</option>
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">
                  Enter filename (for /foto/ directory) or full URL
                </p>
              </div>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center">
                  <input
                    ...
                    className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                  />
                  <label className="ml-2 text-sm text-gray-700">Published (visible in public organization structure)</label>
                </div>
              </div>
