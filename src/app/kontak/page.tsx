...
export default function Kontak() {
  ...
  const getContactValue = (id: string) => {
    const setting = contactSettings.find(s => s.id === id);
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl opacity-90">
              {getContactValue('office-name') || 'Dinas Lingkungan Hidup Kota Tasikmalaya'}
            </p>
          </div>
        </div>
      </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 text-center border border-gray-200 dark:border-gray-700">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  {getContactValue('office-address')?.split('\n').map((line: string, index: number) => (
                    <span key={index}>
                      {line}
                      {index < getContactValue('office-address')!.split('\n').length - 1 && <br />}
                    </span>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 text-center border border-gray-200 dark:border-gray-700">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  {getContactValue('office-phone') && <span>Telepon: {getContactValue('office-phone')}<br/></span>}
                  {getContactValue('office-fax') && <span>Fax: {getContactValue('office-fax')}<br/></span>}
                  {getContactValue('office-whatsapp') && <span>WA: {getContactValue('office-whatsapp')}</span>}
                </p>
              </div>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 text-center border border-gray-200 dark:border-gray-700">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  {getContactValue('office-email-primary') && <span>{getContactValue('office-email-primary')}<br/></span>}
                  {getContactValue('office-email') && <span>{getContactValue('office-email')}<br/></span>}
                  {getContactValue('office-email-complaint') && <span>{getContactValue('office-email-complaint')}</span>}
                </p>
              </div>
            </div>
          </section>
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between items-center py-2 border-b border-gray-200 dark:border-gray-600">
                      ...
                      <span className="text-gray-900 dark:text-white font-semibold">
                        {getContactValue('hours-monday-thursday') || "08:00 - 16:00 WIB"}
                      </span>
                    </div>
                    <div className="flex justify-between items-center py-2 border-b border-gray-200 dark:border-gray-600">
                      <span className="text-gray-700 dark:text-gray-300">Jumat</span>
                      <span className="text-gray-900 dark:text-white font-semibold">
                        {getContactValue('hours-friday') || "08:00 - 11:30 WIB"}
                      </span>
                    </div>
                  </div>
                </div>
          ...
          <section className="mb-12">
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 border border-gray-200 dark:border-gray-700">
              ...
              <div className="grid md:grid-cols-4 gap-6 text-center">
                <a href={getSocialUrl('social-twitter')} className="group">
                  ...
                  <p className="text-gray-700 dark:text-gray-300 group-hover:text-blue-600 dark:group-hover:text-blue-400">
                    {getSocialValue('social-twitter') || '@DLH_Tasikmalaya'}
                  </p>
                </a>
                
                <a href={getSocialUrl('social-facebook')} className="group">
                  <div className="bg-blue-100 dark:bg-blue-900 text-blue-600 dark:text-blue-400 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition duration-300">
                    <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <p className="text-gray-700 dark:text-gray-300 group-hover:text-blue-600 dark:group-hover:text-blue-400">
                    {getSocialValue('social-facebook') || 'DLH Kota Tasikmalaya'}
                  </p>
                </a>
                
                <a href={getSocialUrl('social-youtube')} className="group">
                  ...
                  <p className="text-gray-700 dark:text-gray-300 group-hover:text-red-600 dark:group-hover:text-red-400">
                    {getSocialValue('social-youtube') || 'DLH Tasikmalaya'}
                  </p>
                </a>
                
                <a href={getSocialUrl('social-instagram')} className="group">
                  ...
                  <p className="text-gray-700 dark:text-gray-300 group-hover:text-pink-600 dark:group-hover:text-pink-400">
                    {getSocialValue('social-instagram') || 'DLH Tasikmalaya'}
                  </p>
                </a>
              </div>
            </div>
