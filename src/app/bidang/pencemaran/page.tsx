    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
          ...
          <div className="max-w-4xl mx-auto text-center">
            <div className="flex flex-col items-center justify-center mb-4">
              ...
              <h1 className="text-3xl md:text-5xl font-bold text-center leading-tight">
                Bidang Pengendalian Pencemaran <br className="hidden md:block" />
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <section className="max-w-6xl mx-auto mb-8">
          <div className="bg-white dark:bg-gray-800 shadow-xl rounded-lg p-8">
            <div className="prose dark:prose-invert max-w-none">
              <h2 className="text-3xl text-center font-bold text-gray-800 dark:text-white mb-6 border-b-4 border-green-500 pb-2">Tentang Bidang Pengendalian Pencemaran dan Penaatan Lingkungan Hidup</h2>
        ...
        <section className="max-w-6xl mx-auto mb-12">
          <div className="bg-white dark:bg-gray-800 shadow-xl rounded-lg p-8">
            <div className="prose dark:prose-invert max-w-none">
              <h3 className="text-3xl text-center font-bold text-gray-800 dark:text-white mb-6 border-b-4 border-green-500 pb-2">Rincian tugas Bidang Pengendalian Pencemaran dan Penaatan Lingkungan Hidup:</h3>
              <>
                <div
                  style={{
