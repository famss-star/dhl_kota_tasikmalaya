...
const BidangPengelolaanSampahPage = () => {
  ...
  useEffect(() => {
    const fetchBidangData = async () => {
      try {
        setLoading(true);
        const response = await fetch('/api/bidang/pengelolaan-sampah');
        if (!response.ok) {
        ...
        const processedData = {
          ...
          tugasPokok: (() => {
            try {
              if (typeof data.tugasPokok === 'string') {
                return JSON.parse(data.tugasPokok);
              }
              return Array.isArray(data.tugasPokok) ? data.tugasPokok : [];
            } catch {
              return [];
            }
          })(),
          fungsi: (() => {
            try {
              if (typeof data.fungsi === 'string') {
                return JSON.parse(data.fungsi);
              }
              return Array.isArray(data.fungsi) ? data.fungsi : [];
            } catch {
              return [];
            }
          })()
              ...
              <div className="bg-white dark:bg-gray-800 shadow-xl rounded-lg p-8">
                ...
                <div className="relative">
                  ...
                  >
                    ...
                    >
                      {Array.isArray(bidangData?.tugasPokok) 
            ...
            <section className="max-w-6xl mx-auto mb-12">
              <div className="bg-white dark:bg-gray-800 shadow-xl rounded-lg p-8">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  {Array.isArray(bidangData?.fungsi) 
...
export default BidangPengelolaanSampahPage;
