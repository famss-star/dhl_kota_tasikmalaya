...
export default function Home() {
	...
	return (
		<div className="min-h-screen bg-white dark:bg-gray-900 pt-0 py-8 px-4">
			...
			<section className="grid grid-cols-2 md:grid-cols-3 gap-6 mb-16 mt-8">
				<Link
					href="/pengaduan"
					className="block bg-green-100 dark:bg-green-900 rounded-lg p-6 shadow hover:scale-105 transition-transform"
				>
					<h2 className="font-semibold text-green-700 dark:text-green-200 mb-2">
						Pengaduan Masyarakat
					</h2>
					<p className="text-sm text-gray-600 dark:text-gray-300">
						Laporkan masalah lingkungan di sekitar Anda secara online.
					</p>
				</Link>
				<Link
				...
				>
					...
					<p className="text-sm text-gray-600 dark:text-gray-300">
						Update berita, edukasi, dan artikel lingkungan hidup.
					</p>
				</Link>
				<Link
				...
				>
					...
					<p className="text-sm text-gray-600 dark:text-gray-300">
						Jadwal event, sosialisasi, dan kegiatan DLH Kota Tasikmalaya.
					</p>
				</Link>
				<Link
					href="/pelayanan"
				...
				>
					...
					<p className="text-sm text-gray-600 dark:text-gray-300">
						Informasi dan permohonan layanan perizinan lingkungan.
					</p>
				</Link>
				<Link
					href="/galeri"
				...
				>
					...
					<p className="text-sm text-gray-600 dark:text-gray-300">
						Dokumentasi kegiatan dan edukasi lingkungan hidup.
					</p>
				</Link>
				<Link
					href="/dokumen"
				...
				>
					...
					<p className="text-sm text-gray-600 dark:text-gray-300">
						Peraturan, SOP, dan dokumen penting DLH Kota Tasikmalaya.
					</p>
				</Link>
			</section>
		</div>
